package wanda.springframework.spring5recipeapp.bootstrap;
...
public class DataLoader implements CommandLineRunner {
  ...
  private List<Recipe> loadRecipes() {
    ...
    // Create 'Perfect Guacamole Recipe'
    ...
    guacNotes.setRecipeNotes("For a very quick guacamole just take a 1/4 cup of salsa and "
        + "mix it in with your mashed avocados.\n" +
        "Feel free to experiment! One classic Mexican guacamole has pomegranate seeds and chunks of "
        + "peaches in it (a Diana Kennedy favorite). Try guacamole with added pineapple, mango, "
        + "or strawberries.\n" +
    ...
    tacosRecipe.setDirections("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
        ...
        + "oregano, cumin, sugar, salt, garlic and orange zest. Stir in the orange juice and olive "
        + "oil to make a loose paste. Add the chicken to the bowl and toss to coat all over.\n" +
        "Set aside to marinate while the grill heats and you prepare the rest of the toppings.\n" +
        "3 Grill the chicken: Grill the chicken for 3 to 4 minutes per side, or until a thermometer"
        + " inserted into the thickest part of the meat registers 165F. Transfer to a plate and "
        + "rest for 5 minutes.\n" +
    ...
    tacoNotes.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
        ...
        + "of pickled jalapenos. I can always sniff out a late-night snacker when the aroma of tortillas heating in a hot pan on the stove comes wafting through the house.\n" +
  ...
  private Category getCategory(String description) {
    return this.categoryRepository.findByDescription(description).orElseThrow(() -> new RuntimeException("Category " + description + " not found"));
  }

  private UnitOfMeasure getUnitOfMeasure(String description) {
    return this.unitOfMeasureRepository.findByDescription(description).orElseThrow(() -> new RuntimeException("UnitOfMeasure " + description + " not found"));
  }
}
